# Software Developer Folio ⚡️ [![GitHub](https://img.shields.io/github/license/saadpasta/developer-portfolio?color=blue)](https://github.com/saadpasta/coderChick/blob/master/LICENSE) [![GitHub stars](https://img.shields.io/github/stars/saadpasta/coderChick)](https://github.com/saadpasta/coderChick/stargazers)  [![All Contributors](https://img.shields.io/badge/all_contributors-4-orange.svg?style=flat-square)](#contributors)
...
To view a live example, **[click here](https://coderchick.js.org/)**.
...
```
1) BUILD IMAGE : docker build -t coderchick:latest .
2) RUN IMAGE: docker run -t -p 3000:3000 coderchick:latest
```


## How To Use 

From your command line, clone and run coderChick:

```bash
# Clone this repository
git clone https://github.com/coder-chick/coder-chick.github.io/tree/portfolio/developerFolio-master
...
const socialMediaLinks = {
  ...
  github: "https://github.com/coder-chick",
  linkedin: "https://www.linkedin.com/in/semaa-amin/",
  gmail: "sema.amin9@gmail.com",
  medium: "https://medium.com/@sema.amin9"
};
...
- Navigate to `package.json` and enter your domain name instead of `https://coderchick.js.org/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/coderChick`, add the same to the homepage section of `package.json`.
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/saadpasta/coderChick)
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/saadpasta/coderChick/pulls).
